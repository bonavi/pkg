...
type UserExt struct {
	...
	Interests *interests.Interests `json:"interests,omitempty" bson:"interests"`
}
...
func (u *UserExt) copy() UserExt {
	...
	var userInterests *interests.Interests
	if u.Interests != nil {
		userInterests = pointer.Pointer(u.Interests.Copy())
	}
